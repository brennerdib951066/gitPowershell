...
if ($PSVersionTable.PSVersion.Major -notcontains 7) {
    Write-Host -ForegroundColor DarkRed "Precisa-se do powershell na versão 7 para usar esse programa".ToUpper()
